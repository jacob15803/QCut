...
import 'package:food_delivery/view/menu/Hot3/item_details_view_BR.dart';
import 'package:food_delivery/view/menu/Hot3/item_details_view_PZ.dart';
import 'package:food_delivery/view/menu/Hot3/item_details_view_SH.dart';
...
class HotelMenu3 extends StatefulWidget {
  final Map mObj;
  const HotelMenu3({super.key, required this.mObj});

  @override
  State<HotelMenu3> createState() => _HotelMenu3State();
}

class _HotelMenu3State extends State<HotelMenu3> {
  TextEditingController txtSearch = TextEditingController();

  List menuItemsArr = [
    {
      "image": "assets/img/burg3.jpg",
      "name": "Chicken Burger",
      "rate": "4.9",
      "rating": "124",
                      ...
                      switch (index) {
                        case 0:
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ItemDetailsViewBRHot3()),
                          );
                          break;
                        case 1:
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ItemDetailsViewPZHot3()),
                          );
                          break;
                        case 2:
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ItemDetailsViewSHHot3()),
                          );
                          break;
                        case 3:
                          Navigator.push(
