...
class HotelMenu5 extends StatefulWidget {
  final Map mObj;
  const HotelMenu5({super.key, required this.mObj});

  @override
  State<HotelMenu5> createState() => _HotelMenu5State();
}

class _HotelMenu5State extends State<HotelMenu5> {
  TextEditingController txtSearch = TextEditingController();

  List menuItemsArr = [
    {
      "image": "assets/img/burgfin.jpg",
      "name": "Chic4ken Burger",
      "rate": "4.9",
      "rating": "124",
