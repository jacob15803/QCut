...
class _InboxViewState extends State<InboxView> {
  List inboxArr = [
    {
      "title": "20% Offer Coupon Available Now",
      "detail":
          "Thank you for choosing Q Cut where every bite is a flavor-packed journey! 🙌🍽️",
    },
    {
      "title": "20% Offer Coupon Available Now",
      "detail":
    ...
    {
      "title": "ഇപ്പോൾ വാങ്ങയൽ ഇരട്ടി വാങ്ങാം ",
      "detail":
          "Thank you for choosing Q Cut where every bite is a flavor-packed journey! 🙌🍽️",
    },
    {
