...
class ItemDetailsViewCBDes extends StatefulWidget {
  const ItemDetailsViewCBDes({super.key});

  @override
  State<ItemDetailsViewCBDes> createState() => _ItemDetailsViewCBDesState();
}

class _ItemDetailsViewCBDesState extends State<ItemDetailsViewCBDes> {
  double price = 45;
  int qty = 1;
  bool isFav = false;
