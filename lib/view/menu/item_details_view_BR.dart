...
import 'package:food_delivery/view/menu/Adcart.dart';
...
class ItemDetailsViewBRBR extends StatefulWidget {
  const ItemDetailsViewBRBR({super.key});

  @override
  State<ItemDetailsViewBRBR> createState() => _ItemDetailsViewBRBRState();
}

class _ItemDetailsViewBRBRState extends State<ItemDetailsViewBRBR> {
  double price = 65;
  int qty = 1;
  bool isFav = false;
  List mostPopArr = [
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 25),
                                child: Text(
                                  "Juicy beef patty, fresh lettuce, and tangy pickles, all nestled in a sesame seed bun.",
                                  style: TextStyle(
                            ...
                            return MostPopularCell(
                              ...
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => const HotelMenu3(
                                              mObj: {},
                                            )));
                              },
                            );
