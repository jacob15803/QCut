...
class ItemDetailsViewBRHot3 extends StatefulWidget {
  const ItemDetailsViewBRHot3({super.key});

  @override
  State<ItemDetailsViewBRHot3> createState() => _ItemDetailsViewBRHot3State();
}

class _ItemDetailsViewBRHot3State extends State<ItemDetailsViewBRHot3> {
  double price = 65;
  int qty = 1;
  bool isFav = false;
  List mostPopArr = [
                            ...
                            return MostPopularCell(
                              ...
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => const HotelMenu1(
                                              mObj: {},
                                            )));
                              },
                            );
