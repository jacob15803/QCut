...
class ItemDetailsViewShake extends StatefulWidget {
  const ItemDetailsViewShake({super.key});

  @override
  State<ItemDetailsViewShake> createState() => _ItemDetailsViewShakeState();
}

class _ItemDetailsViewShakeState extends State<ItemDetailsViewShake> {
  double price = 35;
  int qty = 1;
  bool isFav = false;
