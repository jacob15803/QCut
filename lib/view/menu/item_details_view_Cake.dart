...
class ItemDetailsViewCake extends StatefulWidget {
  const ItemDetailsViewCake({super.key});

  @override
  State<ItemDetailsViewCake> createState() => _ItemDetailsViewCakeState();
}

class _ItemDetailsViewCakeState extends State<ItemDetailsViewCake> {
  double price = 45;
  int qty = 1;
  bool isFav = false;
