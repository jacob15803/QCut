...
class ItemDetailsViewSH extends StatefulWidget {
  const ItemDetailsViewSH({super.key});

  @override
  State<ItemDetailsViewSH> createState() => _ItemDetailsViewSHState();
}

class _ItemDetailsViewSHState extends State<ItemDetailsViewSH> {
  double price = 75;
  int qty = 1;
  bool isFav = false;
