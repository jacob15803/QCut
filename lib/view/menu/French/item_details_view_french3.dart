...
class ItemDetailsViewFrench3 extends StatefulWidget {
  const ItemDetailsViewFrench3({super.key});

  @override
  State<ItemDetailsViewFrench3> createState() => _ItemDetailsViewFrench3State();
}

class _ItemDetailsViewFrench3State extends State<ItemDetailsViewFrench3> {
  double price = 175;
  int qty = 1;
  bool isFav = false;
